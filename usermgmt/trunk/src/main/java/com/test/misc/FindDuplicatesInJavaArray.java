...
public class FindDuplicatesInJavaArray {
	...
	public static void main(String args[]) {
		...
		System.out
				.println("Checking array with duplicate using Arrays.sort(): ");
		checkDuplicateUsingArraysSort(new int[]{ 1, 5, 23, 2, 1, 6, 3, 1, 8, 12, 3 });
	}
	...
	public static void checkDuplicateUsingArraysSort(int[] numbers) {
		Arrays.sort(numbers);
