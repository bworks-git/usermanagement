					...
					<div class="col-sm-12">
						<div class="box box-color box-bordered">
							...
							<div class="box-content">
								<form:form action="saveUser" id="save_user" method="post"
									...
									<div class="step" id="secondStep">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<form:select multiple="true" path="userRole" id="userRole"
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<select multiple="true" id="posPermissions" name="posPermissions"
													class="chosen-select form-control">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<select multiple="true" id="negPermissions" name="negPermissions"
													class="chosen-select form-control">
													<c:forEach items="${permissions}" var="permission">
														<option value="${permission.id }">${permission.permissionName }</option>
													</c:forEach>
