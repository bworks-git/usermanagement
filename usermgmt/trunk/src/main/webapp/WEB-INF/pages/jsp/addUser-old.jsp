					...
					<div class="col-sm-12">
						<div class="box box-color box-bordered">
							...
							<div class="box-content">
								<form:form action="saveUser" id="save_user" method="post" commandName="userForm" class="form-horizontal form-validate">
									<div class="form-group">
										<label for="loginId" class="control-label col-sm-2">Login Id</label>
										<div class="col-sm-10">
											<form:input type="text" name="loginId" id="loginId" path="loginId" class="form-control" data-rule-required="true" data-rule-minlength="2" data-rule-maxlength="200"/>
										</div>
									</div>
									<div class="form-group">
										<label for="password" class="control-label col-sm-2">Password</label>
										<div class="col-sm-10">
											<form:input type="password" name="password" id="password" path="password" class="form-control" data-rule-required="true" data-rule-minlength="2" data-rule-maxlength="200"/>
										</div>
									</div>
									<div class="form-group">
										<label for="first_name" class="control-label col-sm-2">First Name</label>
										<div class="col-sm-10">
											<form:input type="text" name="first_name" id="first_name" path="first_name" class="form-control" data-rule-required="true" data-rule-maxlength="500"/>
										</div>
									</div>
									<div class="form-group">
										<label for="last_name" class="control-label col-sm-2">Last Name</label>
										<div class="col-sm-10">
											<form:input type="text" name="last_name" id="last_name" path="last_name" class="form-control" data-rule-required="true" data-rule-maxlength="500"/>
										</div>
									</div>
									<div class="form-group">
										<label for="email" class="control-label col-sm-2">Email</label>
										<div class="col-sm-10">
											<form:input type="text" name="email" id="email" path="email" class="form-control" data-rule-required="true" data-rule-maxlength="500"/>
										</div>
									</div>
									<div class="form-group">
										<label for="mobile" class="control-label col-sm-2">Mobile</label>
										<div class="col-sm-10">
											<form:input type="text" name="mobile" id="mobile" path="mobile" class="form-control" data-rule-required="true" data-rule-maxlength="500"/>
										</div>
									</div>
									<div class="form-group">
										<label for="permissions" class="control-label col-sm-2">Roles</label>
										<div class="col-sm-10">
											<form:select multiple="true" path="userRole" id="userRole" class="form-control">
