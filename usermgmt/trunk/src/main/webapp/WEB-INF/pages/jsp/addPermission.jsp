						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3>
									...
									${response.operationType} Permission
								</h3>
							</div>
							<div class="box-content">
								<form:form action="savePermission" id="savePermission" method="post" commandName="permission" class="form-horizontal form-validate">
									<div class="form-group">
										<label for="role_name" class="control-label col-sm-2">Permission Name</label>
										<div class="col-sm-10">
											<form:input type="text" name="permissionName" id="permissionName" path="permissionName" class="form-control" data-rule-required="true" data-rule-minlength="2" data-rule-maxlength="100"/>
										</div>
									</div>
									<div class="form-group">
